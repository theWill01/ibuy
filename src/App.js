    ...
    <div className="App">
      <section className={!onScroll ? "scrolled current " : "scrolled"}>
        ...
        <article className="bg-[#709ad2]  h-[30px] text-[#E4F2EE] text-[0.45rem] md:text-[0.7rem] ">
          <ul
            className="border border-[#E4F2EE] w-[100%] flex justify-evenly"
            style={{ alignItems: "center" }}
          >
            <li
              className="flex sm:hidden cursor-pointer relative w-[40px] h-[24px] justify-between "
              style={{ alignItems: "center" }}
              onClick={() => toggle()}
            >
      ...
      <section className="border border-blue-500 relative w-full  overflow-hidden">
        <article
          className={
            !menu
              ? "hidden"
      ...
      <section className="footer-box relative">
        <span className="top-btn cursor-pointer">Back To Top</span>
